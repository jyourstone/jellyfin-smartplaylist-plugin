        ...
        apiClient.ajax({
            ...
            try {
                ...
                if (userIdString && userIdString !== '00000000-0000-0000-0000-000000000000') {
                    ...
                    const setUserIdValue = () => {
                        const userSelect = page.querySelector('#playlistUser');
                        if (userSelect) {
                            // Check if the option exists in the dropdown
                            const optionExists = Array.from(userSelect.options).some(opt => opt.value === userIdString);
                            if (optionExists) {
                                setElementValue(page, '#playlistUser', userIdString);
                    ...
                    if (!setUserIdValue()) {
                        ...
                        setTimeout(() => clearInterval(checkUsersLoaded), 3000);
                    }
                }
