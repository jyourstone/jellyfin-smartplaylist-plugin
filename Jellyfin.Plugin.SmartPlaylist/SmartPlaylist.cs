    ...
    public class SmartPlaylist
    {
            ...
            User user, IUserDataManager userDataManager = null, ILogger logger = null)
        {
            ...
            try
            {
                ...
                var similarityComparisonFields = SimilarityComparisonFields ?? OperandFactory.DefaultSimilarityComparisonFields; // Default to Genre and Tags for backwards compatibility
